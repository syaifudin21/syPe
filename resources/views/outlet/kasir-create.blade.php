...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1>Kasir</h1>
            <p>Informasi Kasir yang terdaftar</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('outlet.kasir.store')}}">
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-12">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Kasir" value="{{old('nama')}}">
                                        @if ($errors->has('nama'))
			  ...
			  <div class="tile-footer">
				<div class="row">
				  <div class="col-md-8 col-md-offset-3">
					...
					<small class="form-text text-muted" id="jadwalhelp">Kasir dapat merubah password</small>
				</div>
				</div>
			  </div>
			</div>
