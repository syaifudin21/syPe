  ...
  <header class="app-header" style="background-color: {{env('COLOR_OWNNER', '#fff')}}">
    ...
    <aside class="app-sidebar" style="background-color: {{env('THEME_COLOR')}}">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{(Request::is('admin/ownner') OR \Request::is('admin/ownner/*'))? 'active': ''}}" href="{{route('admin.ownner')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label"> Ownner</span></a></li>
        
        <li><a class="app-menu__item {{(Request::is('admin/outlet') OR \Request::is('admin/outlet/*'))? 'active': ''}}" href="{{route('admin.outlet')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label"> Outlet</span></a></li>
