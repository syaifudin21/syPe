...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1>Dokter {{$ownner->nama}} Update</h1>
            <p>Informasi ownner akan diedit</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('admin.ownner.update')}}">
                    {{ csrf_field() }} @method('PUT') <input type="hidden" name="id" value="{{$ownner->id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-12">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Reporter" value="{{$ownner->nama}}">
                                        @if ($errors->has('nama'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="{{$ownner->username}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="hp" id="hp" placeholder="Handphone" value="{{$ownner->hp}}">
                                        @if ($errors->has('hp'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="alamat" id="alamat" placeholder="Alamat">{{$ownner->alamat}}</textarea>
                            ...
                            <div class="col-sm-12 col-md-3">
                                <img src="{{(!empty($ownner->foto))?asset($ownner->foto): asset('images/thumbnail.svg')}}" style="max-height: 130px" class="rounded" alt="thumbnail" id="foto">
                            </div>
                        </div>
