...
<html>
  ...
  <body>
    ...
    <div class="cover" style="background-color: {{env('COLOR_OUTLET')}}"></div>
    </section>
    <section class="login-content">
      <div class="login-box" style="min-height: 420px;">
        ...
        <div class="form-group text-center">
          Anda Telah Masuk Sebagai outlet, Silahkan Klik dibawah ini untuk menuju beranda outlet
            <br><br>
            <a href="{{url('outlet')}}" class="btn btn-primary">Beranda outlet</a>
            <br><br>
        atau
        <br><br>
        ...
        @else
        <form class="login-form" method="post" action="{{route('outlet.login')}}">
          @csrf
          <h3 class="login-head">Login Outlet</h3>
